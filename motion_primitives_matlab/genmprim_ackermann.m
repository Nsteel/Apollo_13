function[] = genmprim_ackermann(outfilename)
...
if UNICYCLE_MPRIM_16DEGS == 1
    ...
    basemprimendpts0_c(2,:) = [7 0 0 forwardcostmult];
    basemprimendpts0_c(3,:) = [-1 0 0 backwardcostmult];    
    %1/16 theta change
    %Left Fwd
    basemprimendpts0_c(4,:) = [14 2 1 forwardandturncostmult];
    %Right Fwd
    basemprimendpts0_c(5,:) = [14 -2 -1 forwardandturncostmult];
    ...
    %1/16 theta change
    %Left
    basemprimendpts22p5_c(4,:) = [14 8 1 forwardandturncostmult];
    %Right
    basemprimendpts22p5_c(5,:) = [14 3 -1 forwardandturncostmult];
    ...
    %counterclockwise
    %0 theta change 
    basemprimendpts45_c(1,:) = [5 5 0 forwardcostmult];
    basemprimendpts45_c(2,:) = [5 5 0 forwardcostmult];
    basemprimendpts45_c(3,:) = [-5 -5 0 backwardcostmult];    
    %1/16 theta change
    %Left
    basemprimendpts45_c(4,:) = [10 13 1 forwardandturncostmult];
    %Right
    basemprimendpts45_c(5,:) = [13 9 -1 forwardandturncostmult];
